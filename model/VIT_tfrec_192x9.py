...
class TabCNN:
    ...
    def __init__(self, 
        ...
        self.save_folder = self.save_path + self.spec_repr + "VIT_tfrec_192x9_" + datetime.datetime.now().strftime("%Y-%m-%d %H%M%S") + "/"
    ...
    def build_model(self):
        ...
        patches = generate_patch_conv_orgPaper_f(self.patch_size, self.hidden_size, rescale)
        ...
        logits = Dense(units=(self.num_classes * self.num_strings), name='head', kernel_initializer=tf.keras.initializers.zeros)(im_representation)
